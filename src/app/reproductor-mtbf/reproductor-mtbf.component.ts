...
@Component({
  selector: 'app-reproductor-mtbf',
  templateUrl: './reproductor-mtbf.component.html',
  styleUrls: ['./reproductor-mtbf.component.css']
})
export class ReproductorMtbfComponent implements OnInit {
  ...
  this.pantallaAlto = window.innerHeight;
    ...
    grafico()
    {
      ...
      buscarGrafica()
      {
            ...
            let campos = {accion: 800 + this.graficaActual, desde: this.fechaDesde, hasta: this.fechaHasta,  filtroadicional: this.filtroAdicional};
