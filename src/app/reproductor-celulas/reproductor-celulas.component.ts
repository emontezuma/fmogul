...
@Component({
  selector: 'app-reproductor-celulas',
  templateUrl: './reproductor-celulas.component.html',
  styleUrls: ['./reproductor-celulas.component.css'],
  animations: [
    trigger('flyInOut', [
...
export class ReproductorCelulasComponent implements AfterContentInit {
