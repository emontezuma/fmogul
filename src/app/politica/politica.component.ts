...
export class PoliticaComponent implements AfterContentInit {
  ...
  agregarParo() {
   ...
   descargar() {
    let exportCSV: string = "";
        ...
        exportCSV = exportCSV + '"Complejidad de la contrasena (1-2=Largo, 3=Numeros, 4=Combinar Mayus/Minus, 5=Carac especiales, ) ",';
