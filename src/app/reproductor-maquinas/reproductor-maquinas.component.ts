...
@Component({
  selector: 'app-reproductor-maquinas',
  templateUrl: './reproductor-maquinas.component.html',
  styleUrls: ['./reproductor-maquinas.component.css'],
  animations: [
    trigger('flyInOut', [
...
export class ReproductorMaquinasComponent implements AfterContentInit {
